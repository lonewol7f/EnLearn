            ...
            <div class="row">
                <div class="col">
                    ...
                    <div id="login-slides" class="carousel slide" data-ride="carousel" data-interval="false">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img alt="slide 2" class="d-inline-block w-100"
                                     src="../../resources/img/reshot-illustration-system-user-login-GTQRL8HFXU.png"/>
                                <div class="carousel-caption login-register-form-box">
                                    <form:form id="login-form" data-form-type="blocs-form"
                                               class="login-form-placement form-style"
                                    ...
                                    <form id="register_form" data-form-type="blocs-form"
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="optin2"
                                                   data-validation-minchecked-message="You must agree to this before you register to take services of our site."
                                                   data-validation-minchecked-minchecked="1" name="optin2"/>
                        ...
                        <a class="carousel-nav-controls carousel-control-prev" href="#login-slides" role="button"
                           data-slide="prev">
                            <svg width="26" height="26" viewBox="0 0 32 32">
                                <path class="carousel-nav-icon carousel-prev-icon" d="M22,2L9,16,22,30"></path>
                            </svg>
                            <span class="sr-only">Previous</span></a><a
                            class="carousel-nav-controls carousel-control-next" href="#login-slides" role="button"
                            data-slide="next">
                        <svg width="26" height="26" viewBox="0 0 32 32">
