                ...
                <div class="col">
                    ...
                    <div class="row">
                        <form:form action="/teachers/marks-and-access/save" method="post">
                            ...
                            <div class="col">
                                <button type="submit" class="py-2 px-4  btn btn-success hover:bg-green-700 focus:ring-green-500 focus:ring-offset-green-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                    Give Access
                                </button>
