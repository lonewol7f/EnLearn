...
<div class="page-container">
    ...
    <!-- bloc-1 -->
    <!-- Hero -->
    <div class="d-lg-flex position-relative" style="margin: 0 ; padding: 0 ; position: relative ; bottom: 150px;">
...
<svg xmlns="http://www.w3.org/2000/svg"
     ...
     width="267" height="96" preserveAspectRatio="xMidYMid">
<style type="text/css">
  text {
      text-anchor: middle;
      font-size: 80px;
...
<style id="breath-e41f99ed-9c40-46c7-9552-66d17a72498c"
       data-anikit="">@keyframes breath-e41f99ed-9c40-46c7-9552-66d17a72498c {
                          ...
                          100% {
                            ...
                            <p class="lead">best teachers and courses for you from around the world</p>
                        </div>

                        <div class="d-grid d-sm-flex gap-3">
                            <a class="btn btn-primary btn-transition px-6" href="#">Get
                                started</a>
                            <%--TODO gallery eka map krapam--%>
                            <a class="btn btn-link" href="#">Learn more <i class="bi-chevron-right small ms-1"></i></a>
                            <%--TODO map krapam about wage ekk--%>
                        </div>
                    </div>
                    <!-- End Col -->
                </div>
          ...
          c0.7,4.7,1.2,9.5,1.7,14.2l29.3,321c14,154.2,150.6,267.8,304.9,253.8L565.5,957.4z"/>
                    ...
                    <g transform="matrix(1 0 0 1 0 0)" clip-path="url(#mainHeroSVG2)">
                        <image width="750" height="750"
                               xlink:href="../../resources/img/aae4217f-f6b0-4c3e-ae1f-f141fff1f68e.jpg"
    ...
    <!--  Start Features  -->
    <!-- Lists -->
    <div class="container content-space-2 content-space-lg-3" style="padding: 0; margin: 0 20% ; position: relative ; bottom: 300px ">
        <div class="row">
      ...
      <span class="svg-icon text-primary mb-4">
                ...
                <div class="favicons-on-features">
                ...
                <ul class="list-unstyled list-pointer">
                    <li class="list-pointer-item">
                        <a class="link link-secondary">How to use my brain?</a>
                    </li>
                    <li class="list-pointer-item">
                        <a class="link link-secondary">Getting started for exams</a>
                    </li>
                    <li class="list-pointer-item">
                        <a class="link link-secondary">Edit your profile</a>
                    </li>
                    <li class="list-pointer-item">
                        <a class="link link-secondary">View and download invoices</a>
                    </li>
                </ul>
                <!-- End List -->

                <a class="link" href="#">See all articles <i
      ...
      <span class="svg-icon text-primary mb-4">
                ...
                <ul class="list-unstyled list-pointer">
                    <li class="list-pointer-item">
                        <a class="link link-secondary">Working in a good mind</a>
                    </li>
                    <li class="list-pointer-item">
                        <a class="link link-secondary">Delete a human</a>
                    </li>
                    <li class="list-pointer-item">
                        <a class="link link-secondary">Add an bookmark to your browser</a>
                    </li>
                    <li class="list-pointer-item">
                        <a class="link link-secondary">What is the Item Porche E-class NISsn ?</a>
                    </li>
                </ul>
                <!-- End List -->
      ...
      <span class="svg-icon text-primary mb-4">
                ...
                <ul class="list-unstyled list-pointer">
                    <li class="list-pointer-item">
                        <a class="link link-secondary">Getting started
                            for new members</a>
                    </li>
                    <li class="list-pointer-item">
                        <a class="link link-secondary" >Invite new members and give me monie</a>
                    </li>
                    <li class="list-pointer-item">
                        <a class="link link-secondary"  disabled="disabled">use brain</a>
                    </li>
                </ul>
                <!-- End List -->
...
<script>
    ...
    setTextAnimation(0.1, 2.7, 1, 'linear', '#000000', true);
</script>
