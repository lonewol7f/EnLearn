                ...
                <div class="col">
                    <nav class="navbar row navbar-expand-md navbar-light" role="navigation">
                        <a class="navbar-brand" href="index.jsp"><img
                                src="${pageContext.request.contextPath}/resources/img/logo.png" alt="logo"/></a>
                        <button id="nav-toggle" type="button"
                                class="ml-auto ui-navbar-toggler navbar-toggler border-0 p-0" data-toggle="collapse"
                                data-target=".navbar-36863" aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <div class="collapse navbar-collapse navbar-36863 special-dropdown-nav  fullscreen-nav open-down">
                            <ul class="site-navigation nav navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a href="profile-page-advertiser.jsp"
                                       class="nav-link a-btn">profile-page-advertiser</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="${pageContext.request.contextPath}/teachers/notifications"
                                       class="a-btn nav-link">notification-view</a>
                                </li>
                                <li class="nav-item">
