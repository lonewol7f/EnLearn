...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('.modal').on('hidden.bs.modal', function (e) {
        e.target.querySelectorAll(".embed-responsive-item").forEach(videoItem => {
    ...
    document.querySelectorAll("a[onclick^=\"scrollToTarget\"]").forEach(function (targetObj) {
        targetObj.addEventListener("click", function (e) {
            e.preventDefault();
        });
    }); // Prevent page jump on scroll to links
    document.querySelectorAll(".nav-item [data-active-page]").forEach(function (targetObj) {
        targetObj.classList.add(targetObj.getAttribute('data-active-page'));
    }); // Apply Active Link Classes

    // Internet Explorer Polyfill .closest()
    window.Element && !Element.prototype.closest && (Element.prototype.closest = function (e) {
        var t, o = (this.document || this.ownerDocument).querySelectorAll(e), n = this;
        do {
...
function setUpVisibilityToggle() {
    ...
    function toggleVisibility(targetObj) {
        ...
        if (window.getComputedStyle(targetObj, null).getPropertyValue("height") == '0px' || targetObj.classList.contains('object-hidden')) // Show
        {
            ...
            setTimeout(function () {
                targetObj.style.minHeight = height;
                targetObj.style.removeProperty("height");
            }, 360);
        } else // Hide
        {
...
function setUpLightBox() {
    ...
    document.querySelectorAll("[data-lightbox]").forEach(function (lightboxObj) {
        lightboxObj.addEventListener("click", function (e) // Create lightbox Modal
        {
            ...
            if (protectionClass.length) {
                ...
                protectedImg.addEventListener("contextmenu", function (e) {
                    e.preventDefault();
                });
                protectedImg.addEventListener("mousedown", function (e) {
                    e.preventDefault();
                });
            }

            // Close lightbox (required for BS4)
            delegateSelector('body', "click", "[data-bs-dismiss=\"modal\"]", function (e) {
                lightboxModal.hide();
            });
        });
    });
    ...
    function setUpLightboxSwipe() {
        ...
        if (gestureZone) {
            ...
            }, !1), gestureZone.addEventListener("touchend", function (e) {
                touchendX = e.changedTouches[0].screenX, touchendY = e.changedTouches[0].screenY, handleGesture()
            }, !1);
...
function setUpImgProtection() {
    document.querySelectorAll(".img-protected").forEach(function (targetObj) {
        targetObj.addEventListener("contextmenu", function (e) {
            e.preventDefault();
        });
...
$.fn.dropdown = function () {
    var o = $.fn.dropdown;
    return function (d) {
        "string" == typeof d && "toggle" === d && ($(".has-child-dropdown-show").removeClass("has-child-dropdown-show"), $(this).closest(".dropdown").parents(".dropdown").addClass("has-child-dropdown-show"));
        var n = o.call($(this), d);
        return $(this).off("click.bs.dropdown"), n
    }
}(), $(function () {
    $("body").on("click", '.dropdown [data-toggle="dropdown"]', function (o) {
        $(this).dropdown("toggle"), o.stopPropagation()
    }), $("body").on("hide.bs.dropdown", ".dropdown", function (o) {
        $(this).is(".has-child-dropdown-show") && ($(this).removeClass("has-child-dropdown-show"), o.preventDefault()), o.stopPropagation()
    }), $('.dropdown [data-toggle="dropdown"]').on("click", function (o) {
        $(this).dropdown("toggle"), o.stopPropagation()
    }), $(".dropdown").on("hide.bs.dropdown", function (o) {
        $(this).is(".has-child-dropdown-show") && ($(this).removeClass("has-child-dropdown-show"), o.preventDefault()), o.stopPropagation()
    }), $("a.dropdown-toggle").click(function (o) {
        o.preventDefault();
    })
});
...
function scrollToPolyFill() {
    ...
    function d(o) {
        var t = p(o, "Y") && a(o, "Y"), l = p(o, "X") && a(o, "X");
        return t || l
    }
...
function delegateSelector(e, t, c, n) {
    t.split(" ").forEach(t => {
